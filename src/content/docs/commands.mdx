---
title: Commands
description: The implemented Tapid CLI surface and its constraints.
---
...
[Getting started](/docs/getting-started/) · [Package identity](/docs/concepts/package-identity/) · [Evidence and policy](/docs/concepts/evidence-and-policy/)
