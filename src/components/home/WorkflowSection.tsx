...
const trace = [
  ["request", "tapid install is-char", "implemented", "Adds and installs one package from the supported npm subset."],
  ["project path", "tapid install --frozen", "implemented", "Replays an existing lockfile and verified store."],
    ...
    <section className="bg-[#141414] py-20 text-white md:py-24">
      <div className="site-container grid gap-12 lg:grid-cols-[0.72fr_1.28fr] lg:gap-24">
        <SectionHeading title="A command is only useful when you know what it guarantees.">
          <p>Tapid records package identity, artifact integrity, exact dependency edges, and verified tree digests before it activates managed project files.</p>
